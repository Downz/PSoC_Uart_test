...
/* Pin_PWM */
#define Pin_PWM__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Pin_PWM__0__MASK 0x40u
#define Pin_PWM__0__PC CYREG_PRT1_PC6
#define Pin_PWM__0__PORT 1u
#define Pin_PWM__0__SHIFT 6u
#define Pin_PWM__AG CYREG_PRT1_AG
#define Pin_PWM__AMUX CYREG_PRT1_AMUX
#define Pin_PWM__BIE CYREG_PRT1_BIE
#define Pin_PWM__BIT_MASK CYREG_PRT1_BIT_MASK
#define Pin_PWM__BYP CYREG_PRT1_BYP
#define Pin_PWM__CTL CYREG_PRT1_CTL
#define Pin_PWM__DM0 CYREG_PRT1_DM0
#define Pin_PWM__DM1 CYREG_PRT1_DM1
#define Pin_PWM__DM2 CYREG_PRT1_DM2
#define Pin_PWM__DR CYREG_PRT1_DR
#define Pin_PWM__INP_DIS CYREG_PRT1_INP_DIS
#define Pin_PWM__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Pin_PWM__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Pin_PWM__LCD_EN CYREG_PRT1_LCD_EN
#define Pin_PWM__MASK 0x40u
#define Pin_PWM__PORT 1u
#define Pin_PWM__PRT CYREG_PRT1_PRT
#define Pin_PWM__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Pin_PWM__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Pin_PWM__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Pin_PWM__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Pin_PWM__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Pin_PWM__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Pin_PWM__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Pin_PWM__PS CYREG_PRT1_PS
#define Pin_PWM__SHIFT 6u
#define Pin_PWM__SLW CYREG_PRT1_SLW
...
#define CY_PROJECT_NAME "shootingControlSW"
